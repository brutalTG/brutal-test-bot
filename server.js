    ...
    try {
        ...
        if (existing && existing.length > 0) {
            return res.status(409).json({
                ...
                message: 'Ya completaste este Drop.'
            });
        }

        // 3. Check for incomplete session (allow resume)
        ...
        if (incomplete && incomplete.length > 0) {
            return res.json({ session_id: incomplete[0].id, resumed: true });
        }
...
// ================================================================
// API: Save a response (called after each card)
// ================================================================
